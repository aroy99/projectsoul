...
public class Save {
  ...
  public static boolean saveGame(){
    ...
    try {
      ...
      String lastUsedPlayer = MapHandler.getPlayer().getCharacter().toString();
      ...
      gameWriter.println("Current Coordinates: " + MapHandler.getPlayer().getX() + 
            "," + MapHandler.getPlayer().getY());

      gameWriter.println("Caspian:" + " Level: " + Caspian.level + " XP: " + 
            Caspian.xp +" NextLevelUp: " + Caspian.nextLevelUp);
      gameWriter.println("Flannery:" + " Level: " + Flannery.level + " XP: " + 
            Flannery.xp +" NextLevelUp: " + Flannery.nextLevelUp);
      gameWriter.println("Sierra:" + " Level: " + Sierra.level + " XP: " + 
            Sierra.xp +" NextLevelUp: " + Sierra.nextLevelUp);
      gameWriter.println("Bruno:" + " Level: " + Bruno.level + " XP: " + 
            Bruno.xp +" NextLevelUp: " + Bruno.nextLevelUp);
